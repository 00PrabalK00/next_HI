...
static const _MotorFeedback_type_support_symbol_names_t _MotorFeedback_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, next_motor_interface, msg, MotorFeedback)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, next_motor_interface, msg, MotorFeedback)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, next_motor_interface, msg, MotorFeedback)() {
  return &::next_motor_interface::msg::rosidl_typesupport_c::MotorFeedback_message_type_support_handle;
}
